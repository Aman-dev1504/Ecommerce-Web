  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-neutral-50 to-neutral-100">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-purple-50 via-white to-blue-50">
        {/* Gradient Orbs */}
        <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-purple-200/30 rounded-full blur-3xl" />
        <div className="absolute top-1/2 right-0 w-[400px] h-[400px] bg-blue-200/30 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-pink-200/20 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <Badge variant="secondary" className="shadow-sm rounded-full cursor-grab">
              NEW SEASON ARRIVALS
              <ArrowRightIcon className="ml-1 w-4 h-4 transition-transform duration-300 ease-in-out hover:translate-x-1" />
            </Badge>
            ...
            >
              <Button size="lg" className="group hover:text-black">
                Shop Collection
                <ShoppingBag className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Button>

              <RainbowButton className="group bg-white text-black ">
                View Lookbook
          ...
          >
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.6, duration: 0.6 }}
              className="relative aspect-[4/5] rounded-2xl overflow-hidden mt-20"
            >
              <img
